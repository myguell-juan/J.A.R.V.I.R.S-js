...
function takeCommand(message) {
    if (message.includes('hey') || message.includes('hello')) {
        ...
        speak("Alfred, meu irmão mais velho é o computador principal, foi o primeiro a ser desenvolvido com funções básicas que fora aperfeiçoadas por meu criador e por ele mesmo ao longo do tempo, através do que se conhece como aprendizado de máquina na área da tecnologia; atualmente alfred é responsável por gerenciar todo o nosso ecossistema; isso inclui todos os aperelhos e máquinas que meu criador utiliza ou tem acesso.")
